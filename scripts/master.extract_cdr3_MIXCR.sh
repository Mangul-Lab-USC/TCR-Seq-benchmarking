...
while read line
do
echo "python scripts/mixcr.extract.py raw_data/complete_sample/MIXCR_Data/${line}_clones.txt raw_data/complete_sample/MIXCR_Data/extracted_features/${line}.extracted_MIXCR.csv"
